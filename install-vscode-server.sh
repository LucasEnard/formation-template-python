...
if [ -n "${commit_sha}" ]; then
    ...
    ~/.vscode-server/bin/${commit_sha}/bin/code-server --install-extension ms-python.python 
	~/.vscode-server/bin/${commit_sha}/bin/code-server --install-extension ms-python.vscode-pylance 
	~/.vscode-server/bin/${commit_sha}/bin/code-server --install-extension intersystems-community.vscode-objectscript 
	~/.vscode-server/bin/${commit_sha}/bin/code-server --install-extension intersystems.language-server 
    ~/.vscode-server/bin/${commit_sha}/bin/code-server --install-extension intersystems-community.servermanager
